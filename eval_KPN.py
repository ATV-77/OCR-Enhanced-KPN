#python eval_KPN.py --exp_name Totaltext --gpu -1 --eval_vis True
#python eval_KPN.py --exp_name Icdar2015 --gpu -1 --eval_vis True
#python eval_KPN.py --exp_name Ctw1500 --gpu -1 --eval_vis True
...
def inference(detector, test_loader, output_dir_ori):
    ...
    for i, (image, meta) in enumerate(test_loader):
        ...
        # Debugging to check if contours and output are being generated
